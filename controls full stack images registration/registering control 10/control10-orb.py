...
#Establish Paths
path = r'controls full stacks2/control10/'
outpath = r'controls full stacks2/control10/output'
...
for output in registered_images_arr:
    cv2.imwrite('controls full stacks2/control10/output/registered_orb' + str(num) + ".jpg", output)
    num += 1