...
height, width = 425, 425

    #Orb set
akaze = cv2.AKAZE_create()
kp1 , d1 = akaze.detectAndCompute(grey_images[8], None) 
...
for output in registered_images_arr:
    cv2.imwrite('Nerves raw scans2/Control 10/output/registered_akaze' + str(num) + ".jpg", output)
    num += 1