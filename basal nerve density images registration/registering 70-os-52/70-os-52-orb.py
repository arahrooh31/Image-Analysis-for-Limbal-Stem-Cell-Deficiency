...
#Establish Paths
path = r'Basal nerve density2/Moderate/70-os-52/'
outpath = r'Basal nerve density2/Moderate/70-os-52/output'
...
kp1 , d1 = orb_detector.detectAndCompute(grey_images[31], None) 
...
for output in registered_images_arr:
    cv2.imwrite('Basal nerve density2/Moderate/70-os-52/output/registered_orb' + str(num) + ".jpg", output)
    num += 1