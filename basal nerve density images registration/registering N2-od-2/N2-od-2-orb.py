...
#Establish Paths
path = r'Basal nerve density2/Control/N2-od-2/'
outpath = r'Basal nerve density2/Control/N2-od-2/output'
...
kp1 , d1 = orb_detector.detectAndCompute(grey_images[32], None) 
...
transformed_img1 = cv2.warpPerspective(grey_images[32], homography, (width, height)) 
...
for output in registered_images_arr:
    cv2.imwrite('Basal nerve density2/Control/N2-od-2/output/registered_orb' + str(num) + ".jpg", output)
    num += 1