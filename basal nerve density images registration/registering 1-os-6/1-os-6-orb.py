...
#Establish Paths
path = r'Basal nerve density2/Severe/1-os-6/'
outpath = r'Basal nerve density2/Severe/1-os-6/output'
...
kp1 , d1 = orb_detector.detectAndCompute(grey_images[35], None) 
...
for output in registered_images_arr:
    cv2.imwrite('Basal nerve density2/Severe/1-os-6/output/registered_orb' + str(num) + ".jpg", output)
    num += 1