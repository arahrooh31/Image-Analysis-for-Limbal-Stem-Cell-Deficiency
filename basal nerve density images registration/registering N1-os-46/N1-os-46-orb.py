...
#Establish Paths
path = r'Basal nerve density2/Control/N1-os-46/'
outpath = r'Basal nerve density2/Control/N1-os-46/output'
...
kp1 , d1 = orb_detector.detectAndCompute(grey_images[18], None) 
...
for output in registered_images_arr:
    cv2.imwrite('Basal nerve density2/Control/N1-os-46/output/registered_orb' + str(num) + ".jpg", output)
    num += 1