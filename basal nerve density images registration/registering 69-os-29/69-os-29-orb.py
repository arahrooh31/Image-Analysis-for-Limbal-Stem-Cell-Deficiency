...
#Establish Paths
path = r'Basal nerve density2/Mild/69-os-29/'
outpath = r'Basal nerve density2/Mild/69-os-29/output'
...
kp1 , d1 = orb_detector.detectAndCompute(grey_images[24], None) 
...
for output in registered_images_arr:
    cv2.imwrite('Basal nerve density2/Mild/69-os-29/output/registered_orb' + str(num) + ".jpg", output)
    num += 1